...
class Engine:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Ragdoll Rodeo")
    ...
    def on_init(self):
        ...
        # self.ragdoll = Dummy(self.space, self.GameSurface_rect.center)
    ...
    def on_event(self, event):
        ...
        # self.mouseTools.switch_toolset(event)
        # self.mouseTools.switch_tool(event)
