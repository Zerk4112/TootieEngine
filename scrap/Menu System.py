...
class Engine:
    def __init__(self):
        ...
        self.second_surface_x = 75
        self.second_surface_y = 200
        self.frameCount = 0
        self.screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
        self.second_surface = pygame.Surface([self.second_surface_x, self.second_surface_y])
    ...
    def on_render(self):
        ...
        self.screen.blit(self.second_surface, (SCREEN_CENTER_X - (self.second_surface_x / 2), SCREEN_CENTER_Y - (self.second_surface_y / 2)))
        self.draw_text("File", 16, (10, 10))
        pygame.display.flip()
    ...
    def draw_text(self, text, size, pos):
        ...
        self.second_surface.blit(text_surface, text_rect)
